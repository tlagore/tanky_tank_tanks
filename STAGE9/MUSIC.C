...
const Note track[][]=
{
	...
	{  
		...
		/* END EIGHTH BAR */
		/*PLACEHOLDER FOR 2D ARRAY */
		{ 'd', 0, EIGHTH, 4, HALF_VOLUME	},
		{ 'a', 0, QUARTER, 4, HALF_VOLUME	},
		{ 'd', 0, EIGHTH, 4, HALF_VOLUME	},
		{ 'f', 0, QUARTER, 4, HALF_VOLUME	},
		{ 'd', 0, EIGHTH, 4, HALF_VOLUME	},
		{ 'd', 1, QUARTER, 4, HALF_VOLUME	},
		{ 'c', 1, EIGHTH, 4, HALF_VOLUME	},
		{ 'f', 0, QUARTER, 4, HALF_VOLUME	},
		{ 'd', 0, EIGHTH, 4, HALF_VOLUME	},
		{ 'd', 1, EIGHTH, 4, HALF_VOLUME	},
		{ 'c', 1, QUARTER, 4, HALF_VOLUME	},
...
Input:
	UINT32 timeElapse - The time that has passed since the last music update
	UINT16 pause - A boolean flag for whether or not the game is paused
*/
void update_music (UINT32 timeElapsed, UINT16 pause)
{
	UINT16 index;
	if (pause != ON && music_on)
	{
